...
export interface WaveRecordJob {
  id: string;
  app_id: string;
...
interface WaveRecordJobListProps {
  selectedJobId: string | null;
  onSelect: (job: WaveRecordJob) => void;
}

export function WaveRecordJobList({ selectedJobId, onSelect }: WaveRecordJobListProps) {
