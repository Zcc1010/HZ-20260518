...
export default function AppLayout() {
  ...
  const isChatPage = pathname.startsWith("/chat") || pathname === "/wave-record" || pathname === "/setting-check" || pathname === "/setting-parser" || pathname === "/risk-assessment" || pathname === "/fault-analysis";
