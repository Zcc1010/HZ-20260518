...
| 字段 | 来源 | 二次值 |
|------|------|--------|
| CT一次额定值 | SysSettingValue | {{值}} A |
| CT二次额定值 | SysSettingValue | {{值}} A |
| 变比 | 计算: CT一次/CT二次 | {{比值}} |
| 通道一A相差流 | TripInfo/FaultInfo | {{值}} A |
| 通道一B相差流 | TripInfo/FaultInfo | {{值}} A |
| 通道一C相差流 | TripInfo/FaultInfo | {{值}} A |
| 通道二A相差流 | TripInfo/FaultInfo | {{值}} A |
| 通道二B相差流 | TripInfo/FaultInfo | {{值}} A |
| 通道二C相差流 | TripInfo/FaultInfo | {{值}} A |
| 故障相电流 | FaultInfo | {{值}} A |
| 3I0 | FaultInfo | {{值}} A |
...
通道一差流计算:
| 相别 | 二次值 (A) | 计算过程 | 一次值 (kA) |
|------|------------|----------|-------------|
| A相 | {{值}} | {{值}} × {{CT一次}}/{{CT二次}} / 1000 | {{结果}} |
| B相 | {{值}} | {{值}} × {{CT一次}}/{{CT二次}} / 1000 | {{结果}} |
| C相 | {{值}} | {{值}} × {{CT一次}}/{{CT二次}} / 1000 | {{结果}} |
